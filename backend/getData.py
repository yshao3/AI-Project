...
path = 'https://globalindiceshistorical.xignite.com/xglobalindiceshistorical.json/ListIndexGroups?&_token=0A4FBFDA9DEE435CBDB45BC3E0B764DA'
...
def getdata(start_date, end_date, zipcode):
	...
	writer.writerow(["Outcome", "Message", "ID", "delay","year","weather","tempm","tempi","hum","wspdm","wspdi","wgustm","wgusti","vism","visi","pressurem","pressurei","windchillm","windchilli","heatindexm","heatindexi","conds"])
